...
contract StarNotary is ERC721 {
    ...
    function buyStar(uint256 _tokenId) public  payable {
        ...
        // Transfer back to sender if there is any coin left after buying star
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender == owner1 || msg.sender == owner2, "Owners should be the sender");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == owner, "Cannot transfer Star if you are not the owner");
